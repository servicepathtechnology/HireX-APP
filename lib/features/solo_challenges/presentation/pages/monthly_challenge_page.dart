/// Part 2 — Monthly Challenge Detail Page
library;
...
class MonthlyChallengePage extends ConsumerWidget {
  const MonthlyChallengePage({super.key});
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: startAsync.isLoading
                          ? null
                          : () {
                              ref.read(startChallengeProvider.notifier).startMonthly();
                            },
                      style: ElevatedButton.styleFrom(
        ...
        error: (error, stack) => Center(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              ElevatedButton(
                onPressed: () => ref.invalidate(monthlyChallengeProvider),
